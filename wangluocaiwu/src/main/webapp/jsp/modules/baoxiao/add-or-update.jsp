            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑报销</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="money" name="money" class="form-control"
                                               onchange="moneyChickValue(this)" placeholder="报销金额">
                                    </div>
                                    <div class="form-group  col-md-6">
                                        <label>报销详情</label>
...
<script>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                yonghuId: "用户不能为空",
                baoxiaoName: "报销名称不能为空",
                baoxiaoTypes: "报销类型不能为空",
                money: "报销金额不能为空",
                insertTime: "申请时间不能为空",
                baoxiaoContent: "报销详情不能为空",
                baoxiaoYesnoTypes: "是否同意不能为空",
            }
        }).form();
    }
