            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">新闻公告管理</li>
                        <li class="breadcrumb-item active">编辑新闻公告</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                gonggaoName: "新闻公告名称不能为空",
                gonggaoTypes: "新闻公告类型不能为空",
                gonggaoPhoto: "新闻公告图片不能为空",
                insertTime: "新闻公告时间不能为空",
                gonggaoContent: "新闻公告详情不能为空",
            }
        }).form();
    }
